...
public class TestRecord {
	...
	TestRecord(int nFields, int depth, int stringLength, int workerID, int sequence, long numberSize, int[] array, int binsize, String[] locations) {
		...
		Document transmissionHeaderObj = new Document("mediaSourceCd", "mediaSourceCd")
                .append("SubmissionInd", "paperSubmissionInd")
                .append("softwareId", "softwareId")
                .append("submissionChannelCd", "submissionChannelCd")
                .append("Yr", "taxYr")
                .append("Cd", "testCd")
                .append("totalIssuerFormCnt", "totalIssuerFormCnt")
                .append("totalRecipientFormCnt", "totalRecipientFormCnt")
                .append("transmissionTypeCd", "transmissionTypeCd")
                .append("transmitterGrp", "transmitterGrp")
                .append("uniqueTransmissionId", "uniqueTransmissionId")
                .append("vendorCd", "vendorCd")
                .append("vendorGrp", "vendorGrp");

		internalDoc.append("uniqueTransmissionId", "uniqueTransmissionId")
							.append("transmissionHeader", transmissionHeaderObj)
							.append("tcc", "transmitterControlCd")
							.append("receiptId", UUID.randomUUID().toString())
              .append("bucketKey", "transmitterControlCd")
	...
	private String GenerateString() {
		...
		stringBuilder.append("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		stringBuilder.append("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		stringBuilder.append("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		stringBuilder.append("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		stringBuilder.append("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
	...
	private int addFields(Document doc, int seq, int nFields, int depth, int stringLength, long numberSize) {
		...
		while (fieldNo < nFields + seq) {
			...
			// as is every 5th
			{
				...
				// put in a string
				String fieldContent = GenerateString();
